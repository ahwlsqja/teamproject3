...
router.get('/pettype', authSitterMiddleware, sittersController.getSittersBypetType);

// 주소 필터링 목록 조회 API
router.get('/address', authSitterMiddleware, sittersController.getSittersByAddress);
