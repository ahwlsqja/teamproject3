...
router.get(
  "/listofuser",
  authMiddleware,
  reservationsController.findReservationsByUser
);
...
router.get(
  ...
  reservationsController.findReservationsBySitter
);

// 예약 취소 API
router.delete(
  "/cancle/:reservationId",
  authMiddleware,
...
router.put(
  ...
  authMiddlewareSitter,
  reservationsController.ReservationAcceptBySitter
);
...
router.put(
  ...
  authMiddlewareSitter,
  reservationsController.ReservationRejectBySitter
);
